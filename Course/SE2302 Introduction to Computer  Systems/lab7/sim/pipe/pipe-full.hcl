...
#A high-level description of your code. 
#In each case, describe how and why you modified your code.
#In this file, I added the logic of iaddq instruction.
#Add IIADDQ to instr_valid, need_regids, need_valC, 
#d_srcB, d_dstE, aluA, aluB, and set_cc 
