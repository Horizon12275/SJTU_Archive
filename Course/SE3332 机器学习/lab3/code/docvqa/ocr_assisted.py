...
def generate_answer(example):
    ...
    prompt = (
        "Document Text (OCR):\n" + ocr_text + "\n\n"
        "Based on both the document image and the extracted text above, "
        f"answer the following question precisely: {example['question']}\n"
        "Answer:"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default="./results/docvqa_100_results_ocr_assisted.json")
